...
(() => {
        ...
        function o() {
          ...
          function p(n, t, e, r) {
            var o = t && t.prototype instanceof w ? t : w,
              ...
              a = new D(r || []);
            return c(i, "_invoke", { value: P(n, e, a) }), i;
          }
          function h(n, t, e) {
            try {
  ...
  (e.n = (n) => {
    ...
    (() => {
      ...
      function h(n, t) {
        for (var e = 0; e < t.length; e++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            "value" in r && (r.writable = !0),
            Object.defineProperty(n, p(r.key), r);
        }
      }
      function v(n, t, e) {
        return (
      ...
      var m = e(756),
        b = e.n(m);
      const w = (n, t) => t.some((t) => n instanceof t);
      let x, k;
      const S = new WeakMap(),
        E = new WeakMap(),
        j = new WeakMap(),
      ...
      let P = {
        get(n, t, e) {
          if (n instanceof IDBTransaction) {
            if ("done" === t) return E.get(n);
            if ("objectStoreNames" === t) return n.objectStoreNames || j.get(n);
            if ("store" === t)
        ...
        return "function" == typeof n
          ? (t = n) !== IDBDatabase.prototype.transaction ||
            ...
            ? (
              ...
              ? function (...n) {
                  return t.apply(M(this), n), O(S.get(this));
                }
              : function (...n) {
                  return O(t.apply(M(this), n));
                }
            : function (n, ...e) {
                const r = t.call(M(this), n, ...e);
                return j.set(r, n.sort ? n.sort() : [n]), O(r);
              }
      ...
      function O(n) {
        if (n instanceof IDBRequest)
          return (function (n) {
            ...
            return (
              t
                .then((t) => {
                  t instanceof IDBCursor && S.set(t, n);
                })
                .catch(() => {}),
              I.set(t, n),
              t
        ...
        const t = T(n);
        return t !== n && (L.set(n, t), I.set(t, n)), t;
      }
      const M = (n) => I.get(n);
      function D(
        n,
      ...
      var G = v(function n() {
        ...
        tn = e(16),
        en = {};
      (en.styleTagTransform = nn()),
        (en.setAttributes = J()),
        (en.insert = Y().bind(null, "head")),
        (en.domAPI = K()),
        (en.insertStyleElement = X()),
        q()(tn.A, en),
        tn.A && tn.A.locals && tn.A.locals;
      var rn,
        on = document.querySelector("#main");
      (on.innerHTML = ""),
        void 0 === new G() &&
          ((rn = document.createElement("div")).classList.add("spinner"),
          (rn.innerHTML =
